...
Close out the work just completed into the task-log per gwork rules. Communicate with the user in their language; the entry itself may be written in any language. Apply any extra instruction the user passed with this skill invocation.
